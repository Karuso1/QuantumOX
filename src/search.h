...
namespace QuantumOX {
    ...
    private:
        // ----------------- Internal helpers -----------------------------
        int negamax_root(Board& board, int depth, int alpha, int beta);
        int negamax(Board& board, int depth, int alpha, int beta);
        
        int minimax_root(Board& board, int depth, int alpha, int beta);
        int minimax(Board& board, int depth, int alpha, int beta, const std::string& root_player);
